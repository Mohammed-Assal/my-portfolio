  ...
  return (
    <div className="flex flex-col md:flex-row  border-b pb-4 mt-11 ">
      ...
      <div className="md:w-1/2 md:ml-8 text-center md:text-left  ">
        <h2 className="text-3xl text-center font-bold text-white mb-4">{project.title}</h2>
        <p className="mb-4 text-center text-gray-400">{project.description}</p>
        <div className="mb-4 text-center text-gray-300">
          <span className="font-semibold text-center ">Technologies Used: </span>
          {project.technologies.join(', ')}
        </div>
        <div className=" text-center flex    md:justify-start">
            <div className=' space-x-4 gap-3 mx-auto  w-[40%]'>
           {project.siteLink ?<a
...
const AllProjects = () => {
  const projects = [
    
    {
      ...
      description: 'This project utilizes the MERN stack to provide a secure login system, post uploading capabilities, and interaction through likes. It features a responsive design ensuring a seamless user experience across devices.',
